...
public class ClientGameClass {
    ...
    private MainLobbyClass mainLobbyClass;
    ...
    public void updateRoom() {
        ...
        try {
            mainLobbyClass = gson.fromJson(socketReader.readLine(), MainLobbyClass.class);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public MainLobbyClass getRoom() {
        return mainLobbyClass;
    }
    ...
    public List<GameLeaderboardEntry> getLeaderboard() {
        socketWriter.println("leaderboard");
        try {
            String message = socketReader.readLine();
            Type leaderboardType = new TypeToken<ArrayList<GameLeaderboardEntry>>() {}.getType();
